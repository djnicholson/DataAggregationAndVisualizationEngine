...
namespace DAaVE.Library.DataAggregation.Aggregators
{
    ...
    {
        /// <inheritdoc />
        public IEnumerable<AggregatedDataPoint> Aggregate(IOrderedEnumerable<DataPointObservation> contiguousDataSegment)
        {
            IEnumerable<DataPointObservation> remainingPoints = contiguousDataSegment;
